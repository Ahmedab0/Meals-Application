...
class LanguageProvider with ChangeNotifier {
  ...
  changeLan(bool lan) async{
    isEn = lan;
    notifyListeners();
    // setLan to SharedPreferences
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setBool("isEn", isEn);
  }

  // getLan from SharedPreferences
  getLan() async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  dynamic getTexts(String key) {
    if (isEn == true) return en[key];
      return ar[key];
  }
}
